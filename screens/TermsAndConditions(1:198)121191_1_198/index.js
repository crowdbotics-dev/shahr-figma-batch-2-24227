  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_1_202}>
        <Text style={styles.Text_1_202}>Terms &amp; conditions</Text>
      </View>
      <View style={styles.View_1_203}>
        <Text style={styles.Text_1_203}>Last updated: dd/mm/yyyy</Text>
      </View>
      <View style={styles.View_1_208}>
        <Text style={styles.Text_1_208}>
          ...
          lorem tellus. Velit semper suspendisse elementum pharetra. Nulla eros
          blandit lectus eu. Tellus nisi eget aliquet imperdiet eu. Nisl, sit
          vel est at. Sed id vestibulum vestibulum diam vitae sed placerat.
          Turpis scelerisque orci urna dolor arcu, dignissim nec leo. Dictumst
          nunc sed a nisi justo amet ipsum phasellus. Orci amet nunc leo
          elementum enim nec, luctus quisque. Convallis tellus faucibus
          elementum pharetra vulputate. In imperdiet viverra vitae mattis. Leo a
